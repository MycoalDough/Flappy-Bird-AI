...
if(__name__ == "__main__"):
    ...
    agent = Agent(gamma=0.99, epsilon=1, lr=1e-4, input_dims=[3], n_actions=2, mem_size=75_000, eps_min=0.1, batch_size=32, checkpoint_name="bird", eps_dec=2e-4, replace=100)
